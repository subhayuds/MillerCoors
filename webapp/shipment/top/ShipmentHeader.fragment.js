 ...
 * @Description : This is Shipment Header fragment
 */
sap.ui.jsfragment("mc.ccp.shipment.top.ShipmentHeader", {
	
    /** Is initially called once after the Controller has been instantiated. It is the place where the UI is constructed. 
     * Since the Controller is given to this method, its event handlers can be attached right away.
     * @memberOf shipment.top.ShipmentHeader
     */
    createContent: function(oController) {
    	//creating Settings label for Header section
        var oTextView = new sap.ui.commons.TextView({
            text: MCAPP.getText('VW_SHIPMENT_HEADER_TITLE', this),
