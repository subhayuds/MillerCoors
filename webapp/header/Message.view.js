 ...
 * @Description : This is Message view
 */
sap.ui.jsview("mc.ccp.header.Message", {
    ...
    createContent: function(oController) {
        ...
        //Creating Accordion
        var oAccordion = new mc.ccp.header.control.McMsgAccordion(this.createId('msgAccordionId'), {
            width: '500px'
        });
