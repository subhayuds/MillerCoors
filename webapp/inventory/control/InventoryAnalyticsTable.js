 ...
 */
jQuery.sap.declare('mc.ccp.inventory.control.InventoryAnalyticsTable');
jQuery.sap.require("mc.ccp.control.McArrowTextField");
sap.ui.core.Control.extend('mc.ccp.inventory.control.InventoryAnalyticsTable', {
    metadata: {
        properties: {
            'width': {
     ...
     * @memberOf inventory.InventoryAnalyticsTable
     */
    init: function() {
 ...
 * @memberOf inventory.InventoryAnalyticsTable
 */
mc.ccp.inventory.control.InventoryAnalyticsTable.prototype.exit = function(oEvent) {
